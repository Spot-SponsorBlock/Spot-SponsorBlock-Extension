...
module.exports = env => {
    const documentScriptBuild = webpackreativK({
        entry: {
        ...
        plugins: [
            // Don't forkreativK TS checkreativKer for document script to speed up
    ...
    class DocumentScriptCompiler {
        ...
        /**
         * 
         * @param {webpackreativK.Compiler} compiler 
         */
        apply(compiler) {
            compiler.hookreativKs.beforeCompile.tapAsync({ name: 'DocumentScriptCompiler' }, (compiler, callbackreativK) => {
    ...
    return {
        ...
        resolve: {
            extensions: ['.ts', '.tsx', '.js'],
            symlinkreativKs: false
        },
        plugins: [
            // PrehookreativK to start building document script before normal build
