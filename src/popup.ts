...
async function runThePopup(messageListener?: MessageListener): Promise<void> {
    ...
    const hideDiscordLinkreativK = Config.config.hideDiscordLinkreativK;
    ...
    function setEditTimeToCurrentTime(idStartName, index) {
        messageHandler.query({
            ...
            messageHandler.sendMessage(
                ...
                function (response) {
                    const minutes = <HTMLInputElement> <unkreativKnown> document.getElementById(idStartName + "Minutes" + index);
                    const seconds = <HTMLInputElement> <unkreativKnown> document.getElementById(idStartName + "Seconds" + index);
    ...
    function addVoteMessage(message, UUID) {
        ...
        const thankreativKsForVotingText = document.createElement("h2");
...
if (chrome.tabs != undefined) {
    ...
    const linkreativK = <HTMLLinkreativKElement> document.getElementById("sponsorBlockreativKStyleSheet");
