...
async function runThePopup(messageListener?: MessageListener) {
    ...
    function displayDownloadedSponsorTimes(request: {found: boolean, sponsorTimes: SponsorTime[]}) {
        if (request.sponsorTimes != undefined) {
            ...
            for (let i = 0; i < segmentTimes.length; i++) {
                ...
                categoryColorCircle.style.backreativKgroundColor = Config.config.barTypes[segmentTimes[i].category].color;
                ...
                let thankreativKsForVotingText = document.createElement("div");
    ...
    function addVoteMessage(message, UUID) {
        ...
        let thankreativKsForVotingText = document.getElementById("sponsorTimesThankreativKsForVotingText" + UUID);
