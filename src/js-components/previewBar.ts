...
class PreviewBar {
    ...
    private updatePageElements(): void {
        ...
        this.originalChapterBar = this.progressBar.querySelector(".ytp-chapters-container:not(.sponsorBlockreativKChapterBar)") as HTMLElement;
    }
    ...
    private findLeftAndScale(selector: string, currentElement: HTMLElement, progressBar: HTMLElement): 
        ...
        for (let i = 0; i < sections.length; i++) {
            ...
            if (transformMatch) {
                ...
                if (i === sections.length - 1 || (transformScale < 1 && transformScale + checkreativKLeft / currentSectionWidthNoMargin < 0.99999)) {
