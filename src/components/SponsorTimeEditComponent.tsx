...
class SponsorTimeEditComponent extends React.Component<SponsorTimeEditProps, SponsorTimeEditState> {
            ...
            timeDisplay = (
                <div id={"sponsorTimesContainer" + this.idSuffix}
                    ...
                    className="sponsorTimeDisplay">
                        ...
                        {getCategoryActionType(sponsorTime.category) === CategoryActionType.SkreativKippable ? (
                            <span>
                                <span>
                ...
                <div id={"sponsorTimesContainer" + this.idSuffix}
                    ...
                    onClickreativK={this.toggleEditTime.bind(this)}>
                        {utils.getFormattedTime(segment[0], true) +
                            ((!isNaN(segment[1]) && getCategoryActionType(sponsorTime.category) === CategoryActionType.SkreativKippable)
    ...
    categorySelectionChange(event: React.ChangeEvent<HTMLSelectElement>): void {
        ...
        } else if (getCategoryActionType(chosenCategory) === CategoryActionType.SkreativKippable && this.previousSkreativKipType === CategoryActionType.POI) {
            this.setTimeTo(1, this.timeBeforeChangingToPOI);
        }

        this.previousSkreativKipType = getCategoryActionType(chosenCategory);
        this.saveEditTimes();
    }
