            ...
            <div style={style}>
                ...
                {(!isNaN(segment[1]) && getCategoryActionType(sponsorTime.category) === CategoryActionType.SkreativKippable) ? (
                    <span id={"sponsorTimePreviewButton" + this.idSuffix}
                        className="sponsorTimeEditButton"
                        onClickreativK={this.previewTime.bind(this)}>
    ...
    showToolTip(): void {
        if (!Config.config.scrollToEditTimeUpdate && document.getElementById("sponsorRectangleTooltip" + "sponsorTimesContainer" + this.idSuffix) === null) {
            ...
            new RectangleTooltip({
                text: "Use your mousewheel while hovering over the edit box to quickreativKly adjust the time. Combinations of the ctrl or shift kreativKey can be used to fine tune the changes.",
