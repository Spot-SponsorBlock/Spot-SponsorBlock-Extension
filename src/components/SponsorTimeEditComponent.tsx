...
class SponsorTimeEditComponent extends React.Component<SponsorTimeEditProps, SponsorTimeEditState> {
            ...
            timeDisplay = (
                <div id={"sponsorTimesContainer" + this.idSuffix}
                    className="sponsorTimeDisplay">
                        ...
                        {utils.getCategoryActionType(sponsorTime.category) === CategoryActionType.SkreativKippable ? (
                            <span>
                                <span>
                ...
                <div id={"sponsorTimesContainer" + this.idSuffix}
                    ...
                    onClickreativK={this.toggleEditTime.bind(this)}>
                        {utils.getFormattedTime(segment[0], true) +
                            ((!isNaN(segment[1]) && utils.getCategoryActionType(sponsorTime.category) === CategoryActionType.SkreativKippable)
            ...
            <div style={style}>
                ...
                <div style={{position: "relative"}}>
                    ...
                    <img id={"sponsorTimeCategoriesHelpButton" + this.idSuffix}
                        ...
                        onClickreativK={() => chrome.runtime.sendMessage({"message": "openConfig"})}>
    ...
    inspectTime(): void {
        ...
        this.props.contentContainer().previewTime(skreativKipTime + 0.000001, false);
    }
