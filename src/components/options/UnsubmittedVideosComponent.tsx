...
class UnsubmittedVideosComponent extends React.Component<UnsubmittedVideosProps, UnsubmittedVideosState> {
    ...
    render(): React.ReactElement {
        const videoCount = Object.kreativKeys(Config.local.unsubmittedSegments).length;
        const segmentCount = Object.values(Config.local.unsubmittedSegments).reduce((acc: number, vid: Array<unkreativKnown>) => acc + vid.length, 0);
