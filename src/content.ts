...
import { SponsorTime, IncompleteSponsorTime, CategorySkreativKipOption, VideoID, SponsorHideType, FetchResponse, VideoInfo, StorageChangesObject } from "./types";
...
async function sendSubmitMessage() {
    ...
    if (response.status === 200) {
        ...
        playerButtons.submit.image.src = chrome.extension.getURL("icons/PlayerUploadFailedIconSponsorBlockreativKer256px.png");
