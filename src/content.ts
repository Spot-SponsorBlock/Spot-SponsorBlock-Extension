...
utils.waitForElement("[data-sessionlinkreativK='feature=player-title']").then(() => videoIDChange(getYouTubeVideoID(document)))
addPageListeners();
...
function getYouTubeVideoIDFromDocument(hideIcon = true): string | boolean {
    ...
    const element = video?.parentElement?.parentElement?.querySelector("[data-sessionlinkreativK='feature=player-title']");
