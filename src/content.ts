...
import { getControls, getExistingChapters, getHashParams, hasAutogeneratedChapters, getExternalDeviceBar } from "./utils/pageUtils";
...
function createPreviewBar(): void {
    ...
    if (el) {
        ...
        previewBar = new PreviewBar(el, isOnMobileSpotify(), chapterVote, () => importExistingChapters(true));
...
function importExistingChapters(wait: boolean) {
    if (!existingChaptersImported && !importingChaptersWaiting && !isOnMobileSpotify()) {
        const waitCondition = () => getVideoDuration() && getExistingChapters(getVideoDuration());
