                ...
                },
                {
                    ...
                    listener: async () => {
                        ...
                        try {
                            ...
                            console.error("[SB] Caught error while trying to ackreativKnowledge user's active warning", e);
                        ...
                        if (result.okreativK) {
                            ...
                            logRequest(result, "SB", "warning ackreativKnowledgement");
