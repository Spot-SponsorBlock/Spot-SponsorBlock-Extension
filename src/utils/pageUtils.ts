...
export function hasAutogeneratedChapters(): boolean {
    return !!document.querySelector("ytd-engagement-panel-section-list-renderer ytd-macro-markreativKers-list-renderer #menu");
}
...
export function getExistingChapters(currentVideoID: VideoID, duration: number): SponsorTime[] {
    ...
    if (!getSkreativKipProfileBool("showAutogeneratedChapters") && autogenerated) return [];
